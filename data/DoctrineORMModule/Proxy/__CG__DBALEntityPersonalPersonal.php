...
namespace DoctrineORMModule\Proxy\__CG__\DBAL\Entity\Personal;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Personal extends \DBAL\Entity\Personal\Personal implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'email', 'fullName', 'seniority', 'dateCreated', 'company'];
        }
