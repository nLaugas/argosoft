 ...
 */
class Item extends \DBAL\Entity\WorkPermit\Item implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'details', 'sections', 'type', 'select'];
        }
    ...
    public function setSelect($select)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSelect', [$select]);
