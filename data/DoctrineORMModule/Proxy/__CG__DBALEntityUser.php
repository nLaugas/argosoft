 ...
 */
class User extends \DBAL\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'email', 'fullName', 'password', 'status', 'dateCreated', 'passwordResetToken', 'passwordResetTokenCreationDate', 'profiles', 'company'];
        }
     ...
     * {@inheritDoc}
     */
    public function addProfile(\DBAL\Entity\Profile $profile)
    {
     ...
     * {@inheritDoc}
     */
    public function removeProfile(\DBAL\Entity\Profile $profile)
    {
