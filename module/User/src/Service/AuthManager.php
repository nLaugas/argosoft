...
/**
 *  AuthManager ejecuta propiamente la autenticación (login/logout). Este además implementa el filtro de 
 *  acceso, permitiendo o denegando el acceso a usuarios no autenticados sobre determinadas páginas web. 
 */
class AuthManager
{
    /**
